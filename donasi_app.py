...
with st.container():
    ...
    st.header("Berdana Punia Bersama Yayasan Satya Dharma Utama dengan prinsip saling asah asih asuh untuk medukung kegiatan sosial, ekonomi, kemanusiaan dan keagamaan")
    st.write(
...
with st.container():
    ...
    with left_column:
        ...
        st.write(
            ...
            3. Pembangunan fasilitas tempat Pendeta memimpin prosesi 
            ...
            8. Pembangunan Utilitas Air Bersih , Limbah , sampah dan penataan parkir
...
with st.container():
    ...
    with text_column:
        st.subheader("Informasi tentang kegiatan Pembangunan Krematorium dan Rumah duka progress 70 % ")
        st.write(
            """
